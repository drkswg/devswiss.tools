...
- For new tools, use `createToolDefinition` in `lib/tools/registry.ts`, add `app/tools/<slug>/page.tsx`, and validate with `tests/unit`, `tests/integration`, and `tests/e2e`.
